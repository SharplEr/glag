...
class GcLogTest {
    ...
    private static Stream<GcLogFixture> fixtures() {
        return Stream.of(
            new GcLogFixture("/org/sharpler/glag/aggregations/gc-log/serial.log", GcName.Serial, 3, 3),
            new GcLogFixture("/org/sharpler/glag/aggregations/gc-log/parallel.log", GcName.Parallel, 4, 4),
            new GcLogFixture("/org/sharpler/glag/aggregations/gc-log/g1.log", GcName.G1, 4, 4),
            new GcLogFixture("/org/sharpler/glag/aggregations/gc-log/shenandoah.log", GcName.Shenandoah, 1, 6),
            new GcLogFixture("/org/sharpler/glag/aggregations/gc-log/zgc.log", GcName.Z, 1, 8)
        );
    }
